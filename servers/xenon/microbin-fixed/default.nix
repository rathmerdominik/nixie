...
rustPlatform.buildRustPackage rec {
  ...
  patches = [
    ...
    # Fix never expire condition not working
    # https://github.com/szabodanika/microbin/pull/260
    # Never expire condition doesn't work without this and will expire after a week.
    (fetchpatch {
